...
export const DayTours = [
  {
    ...
    Highlights: [
      "Experience a thrill to spot the wildlife of Yala National Park on a guided tour",
      "See the leopards, elephants, and sloth bears n their natural habitat",
      "Enjoy the golden hours of the day to capture stunning images of the animals",
